...
class CapillaryPressurePiecewise(CapillaryPressure):
    def __init__(self, sw_pc0=0.6, pce = 1e5, pc_min=-1e6, pc_max=5e6, 
        ...
        pc_curve_h = interp1d([sw_hm, sw_pc0], [pc_hm, 0], kind='linear', fill_value='extrapolate')(sw_curve_h)
        pc_curve_h = pc_curve_h + (pc_max - pc_curve_h) / curve_factor_h

        pc_curve_l = interp1d([sw_pc0, sw_lm], [0, pc_lm], kind='linear', fill_value='extrapolate')(sw_curve_l)
